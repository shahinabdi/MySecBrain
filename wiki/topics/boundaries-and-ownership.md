...
فرد چگونه مرزی سالم میان مسئولیت خودش و مسئولیت دیگران ترسیم می‌کند — یعنی چه چیزی را باید مالکیت کند (احساسات، خواسته‌ها، محدودیت‌ها، وظایف خودش) و چه چیزی را نباید به‌جای دیگران برعهده بگیرد — و این مرزگذاری در خانواده، عشق، دوستی و کار چه شکلی به خود می‌گیرد؟

## Core Ideas

- تمایز بنیادین: مسئولیت *در برابر* دیگران در برابر مسئولیت *به‌جای* آن‌ها: [[boundaries-mean-being-responsible-to-others-not-for-them]].
...
- در کار، مرزگذاری یعنی مالکیت فقط وظایف و واکنش‌های خودتان: [[work-boundaries-mean-owning-your-own-tasks-and-reactions-not-everyone-elses]].
...
هیچ تناقض مستقیمی با کتاب‌های دیگر یافت نشد.

## Open Questions

- کتاب مشخص نمی‌کند چگونه باید با فردی مرز تعیین کرد که به‌طور ساختاری (مثلاً یک رئیس در سلسله‌مراتب سازمانی) قدرت بیشتری دارد و امکان واقعی مقاومت محدود است. *(unspecified — ask)*
