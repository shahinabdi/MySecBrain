---
type: book
title: ۱۲ قانون برای زندگی
original_title: "12 Rules for Life"
author: Jordan B. Peterson
status: active
translation: 12-rules-for-life-fa
...
کتاب جوردن ب. پیترسون فهرستی از ۱۲ قانون رفتاری برای عبور از پیچیدگی و رنج زندگی ارائه می‌دهد. هر قانون با تمثیلی زیستی، ادبی یا تاریخی معرفی می‌شود و به یک توصیه‌ی عملی می‌رسد. محور مشترک اغلب قوانین، یافتن تعادل میان نظم (امنیت، قانون، پیش‌بینی‌پذیری) و آشوب (خطر، ناشناخته، رشد) است.

## Central Idea

معنا در زندگی نه از حذف رنج و آشوب، و نه از تسلیم کامل به آن، بلکه از پذیرفتن مسئولیت آگاهانه‌ی خود در مدیریت مرز میان نظم و آشوب به‌دست می‌آید — از طریق صداقت با خود، انتخاب دوستان و اهداف درست، و فداکاری هدفمند.

## Key Concepts

- **سلسله‌مراتب و وضعیت بدنی** — جایگاه اجتماعی در شیمی بدن حک می‌شود و وضعیت بدنی هم بازتاب و هم عامل تقویت‌کننده‌ی آن است.
- **مسئولیت‌پذیری فردی پیش از قضاوت جهان** — حتی در برابر رنج واقعی، پاسخ سازنده مسئولیت‌پذیری است، نه سرزنش.
- **صداقت به‌عنوان پیش‌نیاز حل مسئله** — چه در قالب پرهیز از خودفریبی، چه گوش‌دادن واقعی، چه زبان دقیق.
- **تعادل نظم/آشوب** — سرکوب کامل ریسک یا انکار کامل رنج، به همان اندازه‌ی رهاشدن در آشوب مضر است.

## Extracted Zettels

- [[posture-signals-status-in-social-hierarchies]]
- [[self-care-requires-the-same-care-given-to-a-loved-one]]
- [[supportive-friends-enable-improvement-toxic-ones-entrench-decline]]
- [[progress-should-be-measured-against-your-past-self-not-others]]
- [[clear-boundaries-in-parenting-produce-responsible-children]]
- [[taking-responsibility-must-precede-judging-the-world]]
- [[meaningful-goals-outweigh-instant-gratification]]
- [[self-deception-through-life-lies-derails-real-goals]]
- [[listening-to-learn-rather-than-to-win-makes-dialogue-constructive]]
- [[precise-language-converts-chaotic-complexity-into-solvable-order]]
- [[suppressing-natural-risk-taking-harms-more-than-it-protects]]
- [[celebrating-small-joys-amid-suffering-sustains-meaning]]
...
- [[atomic-habits]] — سه رابطه‌ی مشخص شناسایی شد:
  - **بسط:** [[small-habits-compound-into-large-results-invisibly]] مکانیزم زیربنایی [[progress-should-be-measured-against-your-past-self-not-others]] را توضیح می‌دهد.
  - **بسط:** [[habit-contracts-with-social-stakes-increase-follow-through]] توصیه‌ی کلی [[supportive-friends-enable-improvement-toxic-ones-entrench-decline]] را به تکنیکی عملی تبدیل می‌کند.
  - **شرط مرزی:** [[delayed-return-habits-need-attached-immediate-gratification]] دامنه‌ی [[meaningful-goals-outweigh-instant-gratification]] را مشخص می‌کند بدون آنکه آن را نقض کند.
- [[boundaries]] — دو رابطه‌ی بسط شناسایی شد:
  - **بسط:** [[family-of-origin-patterns-shape-adult-boundary-habits]] سمت دیگر (نتیجه‌ی بلندمدت بر فرزند) [[clear-boundaries-in-parenting-produce-responsible-children]] (وظیفه‌ی والد) را نشان می‌دهد.
...
ترجمه‌ی کامل در [[12-rules-for-life-fa]] موجود است.
