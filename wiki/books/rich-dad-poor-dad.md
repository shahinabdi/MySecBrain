...
status: active
translation: rich-dad-poor-dad-fa
...
کتاب رابرت کیوساکی، در قالب روایتی از دو مربی مالی دوران کودکی نویسنده — «پدر فقیر» تحصیل‌کرده و «پدر پولدار» کم‌تحصیل اما ثروتمند — شش درس اصلی درباره‌ی تفکر مالی متفاوت این دو الگو ارائه می‌دهد: از تمایز دارایی و بدهی تا اهمیت سواد مالی، جسارت، و یادگیری گسترده.

## Central Idea

ثروت از کارکردن سخت‌تر یا حقوق بالاتر نمی‌آید، بلکه از تغییر ذهنیت مالی حاصل می‌شود: شناخت دقیق دارایی از بدهی، سرمایه‌گذاری‌مجدد پیوسته، تفکیک حرفه از کسب‌وکار، فهم قانون مالیات، و ترکیب دانش مالی با شهامت ریسک‌کردن — مهارت‌هایی که نظام آموزشی رسمی معمولاً آموزش نمی‌دهد.

## Key Concepts

- **دارایی در برابر بدهی** — معیار جریان نقدی، نه ارزش ظاهری.
- **کسب‌وکار در برابر حرفه** — منبع واقعی ثروت در برابر منبع تأمین هزینه‌های روزمره.
- **مزیت ساختار حقوقی** — شرکت‌ها مالیات و ریسک را بازتوزیع می‌کنند.
- **خلأ آموزش مالی** — مدرسه سواد مالی نمی‌آموزد؛ باید عمداً کسب شود.
- **هوش مالی = دانش + شهامت** — دانش بدون جسارت پیگیری فرصت، ثمری ندارد.
- **یادگیری گسترده بر تخصص باریک** — دانش چندحوزه‌ای، پایه‌ی ثروت.

## Extracted Zettels

- [[the-defining-test-of-an-asset-is-whether-it-puts-money-in-or-takes-money-out-of-your-wallet]]
- [[rich-people-make-their-assets-work-for-them-instead-of-working-for-money]]
- [[a-mortgaged-home-is-usually-a-liability-not-an-asset-despite-conventional-wisdom]]
- [[distinguish-your-profession-from-your-business-to-focus-effort-on-building-assets]]
- [[corporations-let-the-rich-spend-pre-tax-and-limit-personal-risk]]
- [[lack-of-financial-education-is-a-systemic-gap-left-by-schools-not-personal-failing]]
- [[assessing-goal-setting-and-continuous-education-build-financial-intelligence-in-that-order]]
- [[financial-success-requires-courage-as-much-as-knowledge]]
- [[working-to-learn-broadly-builds-more-wealth-than-working-to-earn-through-specialization]]
...
- [[good-to-great]] — یک موافقت و یک تقابل آموزنده:
  - **موافقت:** [[rich-people-make-their-assets-work-for-them-instead-of-working-for-money]] مستقل از [[sustained-momentum-in-one-direction-compounds-into-breakthrough-results]] به همان اصل بنیادین رسیده — نتیجه‌ی بزرگ از سرمایه‌گذاری‌مجدد پیوسته می‌آید، نه جهش ناگهانی.
...
ترجمه‌ی کامل در [[rich-dad-poor-dad-fa]] موجود است.
