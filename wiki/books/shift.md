...
کتاب اتان کراس مجموعه‌ای از ابزارهای عملی و پژوهش‌محور برای «شیفت‌دادن» آگاهانه‌ی حالت هیجانی ارائه می‌دهد: دو ابزار درونی (حواس، توجه)، دو ابزار بیرونی (فضا، افراد)، و چارچوبی نهایی (WOOP) برای تبدیل این ابزارها به برنامه‌ی عملی.

## Central Idea

نمی‌توان از بروز احساسات جلوگیری کرد، اما می‌توان شدت و مدت آن‌ها را از طریق کانال‌های مشخصی — حواس، توجه، فضای فیزیکی، و روابط اجتماعی — آگاهانه تنظیم کرد؛ مهارت اصلی، دانستن این است که کدام ابزار در کدام لحظه، و به چه میزان، مناسب است.

## Key Concepts

- **حواس به‌عنوان شیفت‌دهنده‌ی سریع** — کمترین تلاش، بیشترین اثر آنی.
- **توجه به‌عنوان نورافکن قابل‌هدایت** — جابه‌جایی میان نزدیک‌شدن و فاصله‌گرفتن.
- **فضا به‌عنوان شیفت‌دهنده‌ی بیرونی** — تعویض یا تغییر محیط فیزیکی.
- **سرایت هیجانی** — احساسات ناخودآگاه میان افراد منتقل می‌شوند.
- **مقایسه‌ی اجتماعی خنثی** — اثر آن به دیدگاه، نه به خودِ مقایسه، بستگی دارد.
- **WOOP** — آرزو، نتیجه، مانع، برنامه.

## Extracted Zettels

- [[sensory-cues-are-a-fast-low-effort-lever-for-shifting-mood]]
- [[temporarily-shifting-attention-away-from-distress-can-be-a-healthy-emotional-immune-response]]
- [[deliberately-switching-or-modifying-your-physical-space-shifts-your-emotional-state]]
- [[moods-spread-between-people-through-emotional-contagion]]
- [[social-comparison-is-neutral-until-perspective-determines-whether-it-motivates-or-undermines]]
...
این کتاب هم‌پوشانی مفهومی زیادی با کتاب‌های موجود دارد و عمدتاً نقش «ظریف‌ساز» را ایفا می‌کند — شروطی دقیق و ابزارهای مکمل به اصول کلی موجود می‌افزاید:

- [[good-morning-i-love-you]] — یک رابطه‌ی شرط مرزی:
...
- [[how-a-little-becomes-a-lot]] — دو رابطه‌ی بسط:
  - **بسط:** [[deliberately-switching-or-modifying-your-physical-space-shifts-your-emotional-state]] اصل طراحی محیط را از حوزه‌ی رفتار/عادت به حوزه‌ی هیجان بسط می‌دهد.
...
- [[atomic-habits]] — یک رابطه‌ی بسط:
  - **بسط:** WOOP فرمول [[implementation-intentions-turn-vague-goals-into-concrete-plans]] را با مرحله‌ی تضاد ذهنی ترکیب می‌کند.
- [[12-rules-for-life]] — یک رابطه‌ی شرط مرزی:
...
ترجمه‌ی کامل در [[shift-fa]] موجود است.
